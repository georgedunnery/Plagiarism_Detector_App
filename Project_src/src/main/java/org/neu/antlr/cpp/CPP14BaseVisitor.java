...
/**
 * This class provides an empty implementation of {@link CPP14Visitor}, which can be extended to
...
public class CPP14BaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CPP14Visitor<T> {
   ...
   */
  @Override
  public T visitTypeidofexpr(CPP14Parser.TypeidofexprContext ctx) {
    return visitChildren(ctx);
  }
